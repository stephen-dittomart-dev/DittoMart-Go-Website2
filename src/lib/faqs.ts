...
export const faqs: Faq[] = [
  {
    ...
    a: "Nine: the ONDC rail, which carries Ola and Rapido; Adloggs, Shiprocket Quick, Qwqer, Flash by Shadowfax, Quicka, Pidge and Ek Bharath on the partner rail; and Pro Routing as the optimisation layer. Our own agency fleet sits alongside them. Every one is reachable through the same API call.",
  },
  {
