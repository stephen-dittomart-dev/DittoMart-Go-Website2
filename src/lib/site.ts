export const site = {
  ...
  description:
    "DittoMart Go connects your business to nine delivery networks through one API — Adloggs, Shiprocket Quick, Owter, Flash by Shadowfax, Quicka, Pidge, Ek Bharath, Pro Routing and ONDC carrying Ola and Rapido. Routing, tracking, wallet, billing and settlement handled automatically.",
